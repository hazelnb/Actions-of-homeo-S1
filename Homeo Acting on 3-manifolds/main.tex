...
The remainder of the proof is concerned with showing that $M$ \improve{state hypotheses for orb. bundle lemma} is equivariantly homeomorphic to $\maxcov\times F/\Gamma$, where the action on the quotient is as described in \cref{thm:precise-orbit-bundle}
